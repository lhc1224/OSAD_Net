...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_root',type=str,default='/home/lhc/dataset/AFF_dataset/divide_1/train/images/')
    parser.add_argument('--mask_root',type=str,default="/home/lhc/dataset/AFF_dataset/divide_1/train/masks/")
    parser.add_argument('--ref_path',type=str,default="/home/lhc/dataset/AFF_dataset/divide_1/train/refs/")
    parser.add_argument('--txts_path', type=str, default="/home/lhc/dataset/AFF_dataset/divide_1/train/txts/")
    parser.add_argument("--train_lst_path",type=str,default="/home/lhc/dataset/AFF_dataset/divide_1/train/train.lst")
    ...
    parser.add_argument('--test_image_path',type=str,default="/home/lhc/dataset/AFF_dataset/divide_1/test/images")
    parser.add_argument('--txt_path',type=str,default="/home/lhc/dataset/AFF_dataset/divide_1/test/test_ref_3.txt")
    parser.add_argument('--save_image_path',type=str,default="net_14/save_models/divide_2_b2_s3/")
    parser.add_argument("--test_ref_root",type=str,default="/home/lhc/dataset/AFF_dataset/divide_1/test/refs/")
    # Misc
